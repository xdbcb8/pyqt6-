...
class NewFriend(QDialog):
    ...
    def initUI(self):
        ...
        self.comboBox = QComboBox(group1)
        ...
        grouplayout1.addWidget(QLabel("选择分组"), 2, 0, 1, 1)
        grouplayout1.addWidget(self.comboBox, 2, 1, 1, 2)
    ...
    def loadrandomNamePic(self):
        ...
        with codecs.open(f"{current_dir}\\timres\\name.txt", "r", "utf-8") as f:
            ...
            self.iconpath = f"{current_dir}\\timres\\{self.frineName[0]}.png" # 随机姓名对应的头像
